 ...
 */
final class Version20260518103957 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE price_km (id INT AUTO_INCREMENT NOT NULL, min_length INT NOT NULL, max_length INT NOT NULL, price DOUBLE PRECISION NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE price_km');
