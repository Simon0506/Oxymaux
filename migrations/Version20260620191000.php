 ...
 */
final class Version20260620191000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE day_off (id INT AUTO_INCREMENT NOT NULL, date DATE NOT NULL, type VARCHAR(255) DEFAULT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE reservation ADD CONSTRAINT FK_42C84955634DFEB FOREIGN KEY (dog_id) REFERENCES dog (id) ON DELETE SET NULL');
