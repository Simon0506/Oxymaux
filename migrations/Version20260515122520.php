 ...
 */
final class Version20260515122520 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE google_review (id INT AUTO_INCREMENT NOT NULL, google_review_id VARCHAR(191) NOT NULL, author_name VARCHAR(255) NOT NULL, rating INT NOT NULL, comment LONGTEXT DEFAULT NULL, relative_time_description VARCHAR(255) DEFAULT NULL, profile_photo_url VARCHAR(255) DEFAULT NULL, publish_time DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_E965715EB9F1B03 (google_review_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
