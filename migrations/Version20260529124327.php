 ...
 */
final class Version20260529124327 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE activity ADD canceled TINYINT DEFAULT NULL, ADD reason_cancel LONGTEXT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE activity DROP canceled, DROP reason_cancel');
