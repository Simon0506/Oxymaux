 ...
 */
final class Version20260522114111 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE google_account (id INT AUTO_INCREMENT NOT NULL, access_token LONGTEXT NOT NULL, refresh_token LONGTEXT DEFAULT NULL, expires_at DATETIME NOT NULL, google_calendar_id VARCHAR(255) DEFAULT NULL, last_synced_at DATETIME DEFAULT NULL, needs_sync TINYINT NOT NULL, user_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_83726B22A76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('ALTER TABLE google_account ADD CONSTRAINT FK_83726B22A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE google_account DROP FOREIGN KEY FK_83726B22A76ED395');
